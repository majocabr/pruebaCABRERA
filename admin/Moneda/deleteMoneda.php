...
<?php
 ...
 echo "<div class='navbar-header'><a class='navbar-brand'>Eliminar Moneda</a></div>";
...
$ParroquiaCollectorObj->deleteMoneda($id);
echo "<br>";

echo "<div class='container'>";
echo "<div class='panel panel-default'>";
echo "<div class='panel-heading'>Moneda Eliminada Correctamente</div>";
