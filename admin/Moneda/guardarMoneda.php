...
echo "<div class='navbar-header'><a class='navbar-brand'>Guardar Moneda</a></div>";
echo "<ul class='nav navbar-nav'>";
echo "<li><a href='../readsupremo.php'>Menú</a></li>";
echo "<li><a href='createMoneda.php'>Nuevo</a></li>";
echo "<li><a href='readMoneda.php'>Consulta</a></li>";
echo "</ul>";
...
$ParroquiaCollectorObj->updateMoneda($id,$nombre,$idciudad);
