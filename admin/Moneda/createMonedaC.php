...
$CiudadCollectorObj = new CiudadCollector(); 
 ...
 echo "<div class='navbar-header'><a class='navbar-brand' >Crear Moneda</a></div>";
 ...
 echo "<form method= 'POST' class='form-horizontal' action= 'nuevaMoneda.php' id='moneda' title='Moneda'>";
     
     echo "<div class='form-group'>";     
         echo "<label for='inputName' class='control-label col-xs-2'>Moneda:</label>";
         echo "<div class='col-xs-10'>";
             echo "<input name='nombre' type='text' id= 'nombre' class='form-control' placeholder='Moneda' required>";
         echo "</div>";
     echo "</div>";
     echo "<div class='form-group'>";
...
<div class="text-fieldsl">
  <a href='readMoneda.php'>Regresar</a>                                          
</div>
</aside>
